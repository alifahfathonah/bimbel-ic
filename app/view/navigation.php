      ...
      <div class="container">
        <div class="classy-nav-container breakpoint-off">
          <nav class="classy-navbar navbar2 justify-content-between" id="saasboxNav">
            <!-- Logo--><a class="nav-brand mr-5" href="indonesia-college-yogyakarta.html"><img src="assets/themes/img/core-img/logo.jpg" alt="Logo Bimbel IC" style="max-height:80px"></a>
            <!-- Navbar Toggler-->
              ...
              <div class="classynav">
                <ul id="corenav">
                  ...
                  <li><a href="#">Tentang IC</a>
                    <ul class="dropdown">
                      <li><a href="portfolio-creative.html">- Profil</a></li>
                      <li><a href="portfolio-full-width.html">- Keunggulan</a></li>
                      <li><a href="portfolio-details-one.html">- Visi dan Misi</a></li>
                    </ul>
                  </li>
